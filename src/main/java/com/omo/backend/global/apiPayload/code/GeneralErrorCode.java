package com.omo.backend.global.apiPayload.code;
...
public enum GeneralErrorCode implements BaseErrorCode {
    ...
    // Argument Validation
    METHOD_ARGUMENT_NOT_VALID(HttpStatus.BAD_REQUEST, "ARGUMENT400_1", "Argument Validation을 실패했습니다."),
    TYPE_OR_FORMAT_NOT_VALID(HttpStatus.BAD_REQUEST, "ARGUMENT400_2", "Argument의 타입이나 형식이 올바르지 않습니다."),

    // Json
    JSON_PARSE_ERROR(HttpStatus.BAD_REQUEST, "JSON400_1", "JSON 파싱 중 에러가 발생했습니다.")
    ;
